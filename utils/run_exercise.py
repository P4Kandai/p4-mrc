...
sys.path.append('/home/p4/tutorials/vm/behavioral-model/mininet')
    ...
    def __init__(self, hosts, switches, links, log_dir, bmv2_exe, pcap_dir, **opts):
        ...
        for sw, params in switches.iteritems():
            if "program" in params:
                switchClass = configureP4Switch(
                        ...
                        log_console=False) # log_console=True
            else:
                # add default switch
                switchClass = None
        ...
        for link in host_links:
            ...
            self.addLink(host_name, sw_name,
                         ...
                         max_queue_rate=link['max_queue_rate'],
                         loss=link['loss'],
                         use_htb=True,
                         port2=sw_port)
...
class ExerciseRunner:
    ...
    def parse_links(self, unparsed_links):
        ...
        for link in unparsed_links:
            ...
            if len(link) > 5:
                link_dict['max_queue_rate'] = link[5]
            if len(link) > 6:
                link_dict['loss'] = link[6]
